...
7. HOROVOD_CUDA_HOME=../usr/local/cuda-10.2/ HOROVOD_GPU_OPERATIONS=NCCL pip install horovod==0.19.4
8. add 2> /dev/null to the end of your command. it will disable all stderr messages.
